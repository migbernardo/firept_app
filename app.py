...
app.layout = html.Div([
    ...
    html.Div([
        html.Div([
            html.H1('Fires in Portugal: A Closer Look')
        ...
        html.Div([
            ...
            html.Div([
                html.P('In the visualization below on the left you can see which regions had the most burnt area in '
                       ...
                       'the most burnt area in square hectares per year by clicking on a specific region. The size of '
                       'the locations represents the proportion of burnt area in comparison to the other regions or '
                       ...
                       'the far right is a map depicting the number of fires per year for each region. Hover over '
                       'each region for specific information about the number of fires. Adjust the slider (above) to '
                       'select the year depicted in these three visualizations.', style={'padding': '1%', 'font-size': '90%'})
            ], className='text_box'),
            ...
            html.Div([
                html.P('Now that you know the dimension of the problem and where it is happening, it is important to '
                        ...
                        'total area burned by subcategory. Is Portugal reacting properly to the situation? The '
                        ...
                        'The ratio of spending to area burned is shown with the black line.  Adjust the range slider '
                        '(above) to select the range of years depicted in both visualizations.',  style={'padding': '1%', 'font-size': '90%'})
            ], className='text_box'),
